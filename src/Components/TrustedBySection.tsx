...
const TrustedBySection: React.FC = () => {
  ...
  return (
    <section className="bg-blue-50 py-16 px-4 relative overflow-hidden">
      ...
      <div className="md:px-[80px]">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[30px] text-primary-color font-bold mb-4 font-family-playfair">
            {t('trustedBy.title')}
          </h2>

          <h3 className="text-2xl text-primary-color md:text-3xl font-semibold mb-6 font-family-playfair">
            {t('trustedBy.subtitle')}
          </h3>

          <p className="text-primary-color text-lg max-w-3xl mx-auto leading-relaxed">
            {t('trustedBy.body')}
          </p>
        </div>
